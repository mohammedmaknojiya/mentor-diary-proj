...
<body>
    <div>
        <h1 class="text-center font-weight-bold">Student List</h1>
    </div>
    <hr>
    <div>
        <nav class="navbar navbar-light bg-light justify-content-end">
                ...
                <input class="form-control mr-sm-2 " type="text"  style=" width: 400px;" type="search"
                    placeholder="Search Student Name" id="myinput" aria-label="Search" onkeyup="myFunction()">
            ...
            <tbody>
                    <tr>
                        ...
                        ?>
                            ...
                            <td><?php  echo $res["std_rollno"];  ?></td>
                            <form action="student_list.php" method="post">
                            <td><button class="btn btn-dark" type="submit" value=<?php echo $res["std_rollno"]; ?> name="mybutton" >Visit Student Profile</button></td>
                            </form>
                    </tr>
                    <?php
                        }
...
{
    $_SESSION["single_rollno"]=$_POST["mybutton"];
    header("location: ../html/single_person_details.php");
}
?>